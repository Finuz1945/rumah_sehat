        ...
        <form action="./pages/simpan_lab.php" method="post" class="warp">
            ...
            <label for="pilih_dokterlab">
                ...
                <select name="pilih_dokterlab" id="pilih_dokterlab" class="goldar">
                        <option value="dr. Achmad Riza, Sp.Hem.">dr. Achmad Riza, Sp.Hem.</option>
                        <option value="dr. Dicky putranto, Sp.Hem.">dr. Dicky putranto, Sp.Hem.</option>
                </select>
            </label>
            <label for="janji_lab">
            <span>Kepentingan janji</span>
                <input type="text" name="janji_lab" id="janji_lab" value="Test Darah" readonly>
            </label>
