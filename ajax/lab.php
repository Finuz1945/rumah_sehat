    ...
    <table class="tampil-table">
      ...
      <?php
        ...
        if ($jumlah_data > 0) {    
          ...
          $query = "SELECT * FROM lab WHERE pilih_dokterlab LIKE '%$keyword%' OR pilih_tanggallab LIKE '%$keyword%' OR pilih_jamlab LIKE '%$keyword%' OR janji_lab LIKE '%$keyword%' limit $halaman_awal, $batas";
        ...
        <?php } else{
                echo "<tr><td colspan=6>Data janji lab Tidak Ditemukan</td></tr>";
          } ?>
        </table>
