...
if ($jumlah_data > 0) {
    ...
    while ($d = mysqli_fetch_assoc($data_janji)) { ?>
                    <tr>
						...
						<td>
                            <a href="waktu-rs.php?id=<?php echo $d['id_rs'];?>" class="page-link">Edit</a>
                            <a href="./pages/hapus-rs.php?id=<?php echo $d['id_rs']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="page-link">Hapus</a>
                        </td>
					</tr>
					<?php } ?>
            </tbody>
